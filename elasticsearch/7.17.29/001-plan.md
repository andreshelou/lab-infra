...
Durante esta etapa se estudiarán:
...
Se realizarán distintos escenarios:

- Caída de un nodo.
- Caída de dos nodos.
- Pérdida del Master.
- Rebalanceo.
- Recuperación del cluster.
...
Finalmente se documentará el procedimiento completo de migración desde Elasticsearch 7.17.29 hacia OpenSearch 2.15.
...
- Un cluster Elasticsearch funcional.
- Procedimientos documentados.
- Base para futuras prácticas y migraciones.